...
class UserController {
  ...
  async activate(req, res, next) {
    try {
      ...
      return res.redirect(`${process.env.CLIENT_URL}/actiovation?success=true`);
    } catch (e) {
      switch (e.code) {
        case 'INVALID_ACTIVATION_LINK': 
          return res.redirect(`${process.env.CLIENT_URL}/activation?success=false&errorCode=${e.code}`);
