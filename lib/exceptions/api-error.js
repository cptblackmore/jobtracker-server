module.exports = class ApiError extends Error {
  ...
  static PlaceNotFoundError() {
    return new ApiError(404, 'Place not found', 'PLACE_NOT_FOUND');
  }
  ...
  static TooManyVacanciesRequestsError() {
    return new ApiError(429, 'Too many vacancies requests', 'TOO_MANY_VACANCIES_REQUESTS');
  }
